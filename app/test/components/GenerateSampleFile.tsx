...
export default function GenerateSampleFile(
) {
  const worksheetName = "Thông tin nhân viên"
  const workbook = new Excel.Workbook();
  const header = ["email", "name", "password", "gender", "phone", "role", "dob", "skills"];
  ...
  return (
    <>
      ...
      <div style={{ textAlign: 'center' }}>
        <div className='mb-2'>
          Tên File: <input id={myInputId} defaultValue={fileName} className='border border-slate-400 ' /> .xlsx
        </div>
        <div>
          ...
          <div className='mt-4'>
            <Button variant='outline' className='bg-blue-500 text-white hover:bg-blue-500 hover:text-white shadow-md hover:shadow-lg' onClick={saveExcel}>Tải xuống</Button>
          </div>
