    ...
    <div>
      ...
      <div className="bg-cover bg-service-background xl:h-[770px] lg:h-[670px] relative w-full flex justify-between">
        ...
        <div className="lg:w-6/12 xl:w-4/12 text-crusta p-20 lg:mt-16 mt-24 lg:ml-24 xl:ml-32 z-30">
          ...
          <h3 className="text-[40px] font-semibold dark:text-slate-600">Nhân Viên của TCH</h3>
          <desc className="dark:text-slate-500">
            Đội ngũ nhân viên đầy nhiệt huyết và tận tâm của TCH - những người làm việc với sứ mệnh tạo ra không gian sống và làm việc sạch sẽ, thoải mái và an toàn cho mọi khách hàng. Với sự chuyên nghiệp, kỹ năng và tận tâm, đội ngũ nhân viên của chúng tôi cam kết mang lại dịch vụ vệ sinh và dọn dẹp tốt nhất. Chúng tôi tự hào về mỗi thành viên trong đội ngũ đều đóng góp vào sự thành công và phát triển không ngừng của TCH trong ngành công nghiệp dịch vụ vệ sinh.
          </desc>
          <br />
